          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={menuPriceDelta > 0 ? 'default' : menuPriceDelta < 0 ? 'destructive' : 'secondary'}>
                      {menuPriceDelta >= 0 ? '+' : ''}{menuPriceDelta}%
                    </Badge>
                  </div>
                  <Slider
                    value={[menuPriceDelta]}
                    onValueChange={(value) => setMenuPriceDelta(value[0])}
                    max={30}
                    min={-20}
                    step={1}
                    className="w-full"
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={ingredientCostDelta > 0 ? 'destructive' : ingredientCostDelta < 0 ? 'default' : 'secondary'}>
                      {ingredientCostDelta >= 0 ? '+' : ''}{ingredientCostDelta}%
                    </Badge>
                  </div>
                  <Slider
                    value={[ingredientCostDelta]}
                    onValueChange={(value) => setIngredientCostDelta(value[0])}
                    max={50}
                    min={-30}
                    step={1}
                    className="w-full"
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={electricRateDelta > 0 ? 'destructive' : electricRateDelta < 0 ? 'default' : 'secondary'}>
                      {electricRateDelta >= 0 ? '+' : ''}{electricRateDelta}%
                    </Badge>
                  </div>
                  <Slider
                    value={[electricRateDelta]}
                    onValueChange={(value) => setElectricRateDelta(value[0])}
                    max={40}
                    min={-20}
                    step={1}
                    className="w-full"
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={laborProductivityDelta > 0 ? 'default' : laborProductivityDelta < 0 ? 'destructive' : 'secondary'}>
                      {laborProductivityDelta >= 0 ? '+' : ''}{laborProductivityDelta}%
                    </Badge>
                  </div>
                  <Slider
                    value={[laborProductivityDelta]}
                    onValueChange={(value) => setLaborProductivityDelta(value[0])}
                    max={50}
                    min={-30}
                    step={1}
                    className="w-full"
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant={wasteDelta < 0 ? 'default' : wasteDelta > 0 ? 'destructive' : 'secondary'}>
                      {wasteDelta >= 0 ? '+' : ''}{wasteDelta}%
                    </Badge>
                  </div>
                  <Slider
                    value={[wasteDelta]}
                    onValueChange={(value) => setWasteDelta(value[0])}
                    max={30}
                    min={-70}
                    step={1}
                    className="w-full"
                ...
                <Button onClick={handleApplyDeltas} className="w-full">
