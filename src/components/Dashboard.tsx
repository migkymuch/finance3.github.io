...
export default function Dashboard({ currentScenario, financialData }: DashboardProps) {
  ...
  const costBreakdown = [
    { name: 'วัตถุดิบ', value: kpis.foodCostPct, color: '#8884d8' },
    { name: 'แรงงาน', value: kpis.laborPct, color: '#82ca9d' },
    { name: 'ค่าใช้จ่ายคงที่', value: 100 - kpis.foodCostPct - kpis.laborPct, color: '#ffc658' },
  ];
